...
pub fn email_valid(_: &Mn, value: &str) -> Result<Option<String>> {
    check(EMAIL_REGEX.is_match(value), "Email is not valid.")
}

pub fn name_valid(_: &Mn, value: &str) -> Result<Option<String>> {
    check(!value.is_empty(), "Name is required.")
}

pub fn password_valid(_: &Mn, value: &str) -> Result<Option<String>> {
